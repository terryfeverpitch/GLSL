...
extern void scene_special(int);
extern void get_scene_light_pos(float*);

extern int SHADOWMAPTURN, REALTURN;
extern int total_score;
extern vector<Food> shroom;
// light positions
...
{
	int shadowMapWidth  = windowWidth * SHADOW_MAP_RATIO;
	int shadowMapHeight = windowHeight * SHADOW_MAP_RATIO;
...
{
	gluPerspective(_fovy_, 1.0f, 2.0f, 24.0f);  // light projection
}
...
int main(int argc, char** argv)
{
	...
	mainwin = glutCreateWindow("Yoshi with Shadow Mapping.");
