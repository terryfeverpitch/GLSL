...
static float Plane[4] = {0,1,0,0};			// ax + by + cz + d = 0, [a,b,c] normalized
...
void main(int argc, char** argv)
{
    ...
    mainwin = glutCreateWindow("Yoshi with Stencil Shadow.");
    glutDisplayFunc(display);
    glutReshapeFunc(reshape);
    viewer = ViewerNew(mainwin, 0,0,512,512, content);
    init();
